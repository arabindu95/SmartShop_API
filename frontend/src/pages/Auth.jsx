          ...
          <div className="flex-col justify-center items-center p-10 rounded-xl shadow-lg shadow-blue-300 border border-slate-700 w-[450px]">
            <div className="flex gap-4 mb-6 w-full items-center justify-center">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-medium w-48 ${
                  mode === "signup" ? "bg-blue-800 text-white" : "bg-slate-800 "
                }`}
              >
                Signup
              </button>
            ...
            {mode === "login" ? (
              <form className="text-center">
                <div>
                  ...
                  <div className="mt-8">
                    <button className="w-full p-3 rounded-md bg-green-800 border border-slate-700 focus:outline-none hover:bg-green-700 duration-300 ">
                      Sign in
                    </button>
                  </div>
